...
export class VideoService {
  ...
  async getVideoList(query: {
    ...
    // .leftJoinAndSelect(TermRelationShipsBasicEntity, 'trTag', 'post.id = trTag.objectId')
    // .leftJoinAndSelect(TermTaxonomyEntity, 'ttTag', 'trTag.termId = ttTag.termId')
    // .leftJoinAndSelect(TermEntity, 'termTag', 'termTag.id = ttTag.termId')
    // .andWhere('ttTag.taxonomy = :taxonomyActor', { taxonomyActor: 'post_tag' })
    // .andWhere('termTag.slug IN (:...tagName)', { tagName: query.includedCategories });
